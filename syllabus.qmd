...
### Python Resources
- Sheppard, K. *Introduction to Python for Econometrics, Statistics and Data Analysis*. University of Oxford. Jupyter notebooks with YouTube lectures. [github.com/bashtage/python-introduction](https://github.com/bashtage/python-introduction)
- Chen, W. *Econometrics with Python*. Lecture notes covering regression, panel data, and time series in Python. [github.com/weijie-chen/Econometrics-With-Python](https://github.com/weijie-chen/Econometrics-With-Python)
