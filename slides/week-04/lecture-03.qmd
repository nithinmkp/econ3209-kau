...
agri["deposit_crore_per_thousand_members"] = agri["deposit_crore"] / agri["members_thousand"]
print(agri)
```
...
df = pd.DataFrame({
    'district':      ['Palakkad', 'Wayanad', 'Thrissur', 'Idukki'],
    'yield_kg':      [3800, np.nan, 4200, 3650],
    'deposit_crore': [420, 180, 610, 220]
})
print("Before cleaning:")
print(df)

df['yield_kg']     = df['yield_kg'].fillna(df['yield_kg'].mean())
df['yield_tonnes'] = df['yield_kg'] / 1000
