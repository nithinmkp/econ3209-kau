---
title: "Plot Refinement & Publication-Ready Figures"
...
axes[0].plot(years, deposits, marker='o', color='#7AB87A')
...
ax.bar(categories, prices, color=['#7AB87A', '#3A8F2B', '#8AA624', '#DAB300'])
...
deposits = [420, 460, 490, 530]
loans    = [310, 340, 370, 395]

fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(10, 4))

ax1.plot(years, deposits, color='#4A7A47', marker='o')
ax1.set_title('Deposits (₹ crore)')
ax1.set_xlabel('Year')

ax2.plot(years, loans, color='#DAB300', marker='s')
ax2.set_title('Loans Outstanding (₹ crore)')
ax2.set_xlabel('Year')
