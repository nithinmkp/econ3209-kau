...
yields   = np.array([3000, 3200, 2900, 3600, 3400])
improved = yields + 200
mask     = improved > 3300

print("Original yields:", yields)
print("After irrigation (+200):", improved)
print("Mask (>3300):", mask)
print("High-yield farms:", improved[mask])
```
