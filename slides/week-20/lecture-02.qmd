...
mape_naive = np.mean(np.abs((test['paddy_production'] - naive_forecast) / test['paddy_production'])) * 100
mape_arima = np.mean(np.abs((test['paddy_production'] - arima_forecast) / test['paddy_production'])) * 100
print('RMSE:', round(rmse_naive, 3), round(rmse_arima, 3))
print('MAPE:', round(mape_naive, 3), round(mape_arima, 3))
```
