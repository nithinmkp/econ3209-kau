...
df['repayment_score'] = (65 + 0.9*df['income']
                            + 1.4*df['collateral']
                            - 0.08*df['loan_size']
...
print(f"Income:     {b['income']:.3f}  → a ₹1,000 rise in monthly income raises the repayment")
print(f"            score by {b['income']:.2f} points, holding collateral and loan size constant.")
print()
print(f"Collateral: {b['collateral']:.3f}  → each additional ₹1 lakh in collateral raises the")
print(f"            repayment score by {b['collateral']:.2f} points, ceteris paribus.")
print()
print(f"Loan size:  {b['loan_size']:.3f} → a ₹1,000 larger loan lowers the repayment score")
print(f"            by {abs(b['loan_size']):.3f} points, all else equal.")
print()
