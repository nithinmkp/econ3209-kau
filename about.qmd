...
- **Kevin Sheppard** (University of Oxford) — *Introduction to Python for Econometrics, Statistics and Data Analysis* — an outstanding resource for economists learning Python, available at [kevinsheppard.com](https://www.kevinsheppard.com/teaching/python/notes/).
- **Weijie Chen** (QuantEcon / ANU) — *Python Programming for Economics and Finance* — part of the QuantEcon lecture series, available at [python-programming.quantecon.org](https://python-programming.quantecon.org).
